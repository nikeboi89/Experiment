...
static NSString * const HNPhotoAlbumLayoutPhotoCellKind = @"PhotoCell";

@interface HNPhotoAlbumLayout()

@property (nonatomic, strong) NSDictionary *layoutInfo;

@end

@implementation HNPhotoAlbumLayout
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[HNPhotoAlbumLayoutPhotoCellKind] = cellLayoutInfo;
...
{
    return self.layoutInfo[HNPhotoAlbumLayoutPhotoCellKind][indexPath];
}
